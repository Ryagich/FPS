...
namespace YG.Insides
{
    public class ConfigYG : MonoBehaviour
    {
        ...
        {
            var ygPrefab = (GameObject)AssetDatabase.LoadAssetAtPath(patchYGPrefab, typeof(GameObject));
            if (ygPrefab == null)
            {
            ...
            var ygScr = ygPrefab.GetComponent<YandexGame>();
            if (ygScr == null)
            {
