...
public static class VectorExtensions
{
    ...
    public static Vector2 WithX2(this Vector2 vector, float x) => new Vector2(x, vector.y);
    public static Vector2 WithY2(this Vector2 vector, float y) => new Vector2(vector.x, y);
}
