...
public class HealthManager : MonoBehaviour
{
    ...
    public class DamageInfo
    {
        ...
        public DamageInfo(Vector3 location, Vector3 direction, float damage,bool isPlayer, Collider bodyPart = null,
    ...
    public virtual void TakeDamage(Vector3 location, Vector3 direction, float damage, bool isPlayer,
        Collider bodyPart = null, GameObject origin = null)
    {
    }
    ...
    {
        this.TakeDamage(damageInfo.location, damageInfo.direction, damageInfo.damage,damageInfo.isPlayer, damageInfo.bodyPart,
        damageInfo.origin);
    }
}